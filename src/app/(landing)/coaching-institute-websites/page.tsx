...
const content: LandingContent = {
  ...
  outcomes: [
    ...
    "Enquiry forms that qualify leads — course, batch, budget — before you call",
  ...
  steps: [
    ...
    },
    {
      ...
      body: "Your website designed, built and live — typically within 3–6 weeks — with training so your team can update content themselves.",
    },
  ],
  faqs: [
    {
